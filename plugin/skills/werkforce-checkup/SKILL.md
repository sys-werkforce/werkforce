...
- **Fix a broken board column row** back to `| Task | Stage | Seat | Filed | Due | Receipt |`, stages `Filed | In progress | Blocked | In review | Done | Dropped`. I touch the scaffold line only, never your task rows.
