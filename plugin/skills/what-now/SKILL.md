...
8. **Work sitting at In review** - rows waiting on a verdict on any Active board. Why: finishing beats starting - each of those rows is one adversarial Reviewer pass away from Done, and no agent grades its own homework. Say: "run the review desk".
